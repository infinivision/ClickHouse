...
void MergeTreeData::swapActivePart(MergeTreeData::DataPartPtr part_copy)
{
    ...
    for (auto original_active_part : getDataPartsStateRange(DataPartState::Committed)) // NOLINT (copy is intended)
    {
        if (part_copy->name == original_active_part->name)
        {
            ...
            /// We do not check allow_remote_fs_zero_copy_replication/allow_remote_fs_zero_copy_replication here because data may be shared
            /// when allow_remote_fs_zero_copy_replication/allow_remote_fs_zero_copy_replication turned on and off again
